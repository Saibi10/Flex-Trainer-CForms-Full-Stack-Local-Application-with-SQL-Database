...
{
    public partial class PlanDiv3 : UserControl
    {
        #region Properties
        ...
        private void planDetailBtn_Click_1(object sender, EventArgs e)
        {
            detailBtn?.Invoke(this, e);
        }

        private void planSubscriberBtn_Click_1(object sender, EventArgs e)
        {
